...
import { Eye, EyeOff, Mail, Lock, ArrowRight, Shield, Users, Activity } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 relative overflow-hidden">
        ...
        <div className="relative flex flex-col justify-center px-12 py-12 text-white">
          <div className="max-w-lg">
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              Streamline your customer relationships, track leads, and boost sales with our comprehensive CRM solution designed for modern businesses.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="text-blue-100">Manage unlimited contacts and leads</span>
              </div>
              <div className="flex items-center">
                <div className="flex-shrink-0 w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center mr-3">
                  <Activity className="w-4 h-4" />
                </div>
                <span className="text-blue-100">Track all customer interactions</span>
              </div>
              <div className="flex items-center">
                <div className="flex-shrink-0 w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center mr-3">
                  <Shield className="w-4 h-4" />
                </div>
                <span className="text-blue-100">Secure and reliable data protection</span>
              </div>
            </div>
            ...
            <div className="mt-12 p-6 bg-white bg-opacity-10 rounded-lg backdrop-blur-sm">
              <p className="text-blue-100 italic mb-3">
                "This CRM has transformed how we manage our customer relationships. The interface is intuitive and the features are exactly what we needed."
              </p>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-200">CEO, TechStart Inc.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-indigo-400 bg-opacity-20 rounded-full blur-lg"></div>
      </div>
    </div>
  );
};
